...
Event.create(user_id: 1, title: "Dope Wedding", start_date: "February 20, 2016 15:00", end_date: "February 21, 2016 22:00", description: "Yo come to this wedding bruh it's gon be so tight. So many cool peeps coming and they all know how to party yo. Omg it's gon' be soooooooooo dope.")
Event.create(user_id: 2, title: "Classy Party", start_date: "August 4, 2016 14:00", end_date: "August 5, 2016 22:00", description: "This party so freaking classy. Come dressed in your most classy attire. There's gon' be so much wine and cheese and stuff. Bring your own olives.")
